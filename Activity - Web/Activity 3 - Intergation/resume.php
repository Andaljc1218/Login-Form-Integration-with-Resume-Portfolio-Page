...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* Header */
        .header { display: grid; grid-template-columns: 110px 1fr auto; gap: 18px; align-items: center; }
        ...
        .logout { display:inline-block; padding: 8px 12px; border:1px solid var(--border-strong); border-radius:6px; text-decoration:none; color:#b91c1c; font-weight:700; }
        ...
        .section-box { border: 1px solid var(--border); border-radius: 8px; padding: 16px; background: var(--card); }
        /* Tables */
        .table { border: 1px solid var(--border); border-radius: 6px; overflow: hidden; background: var(--card); }
        .table-row { display: grid; grid-template-columns: 220px 1fr; gap: 10px 16px; padding: 10px 12px; border-top: 1px solid var(--border); align-items: start; }
        .table-row:first-child { border-top: none; }
        .info-label { font-weight: 700; font-size: 12px; color: #222; letter-spacing: .3px; }
        ...
        /* Projects layout (full width content + action) */
        .project-table { border: 1px solid var(--border); border-radius: 6px; overflow: hidden; background: var(--card); }
        ...
        .project-link { display: inline-block; padding: 6px 10px; border: 1px solid var(--border-strong); border-radius: 6px; color: var(--link); text-decoration: none; font-weight: 600; font-size: 13px; }
        .project-link:hover { background: #f5f7ff; text-decoration: none; }
        @media (max-width: 720px) { .header { grid-template-columns: 80px 1fr auto; } .name { font-size: 24px; } .table-row { grid-template-columns: 1fr; } .align-right { text-align: left; margin-top: 6px; } .project-row { grid-template-columns: 1fr; } }
    </style>
</head>
<body>
    <div class="page">
